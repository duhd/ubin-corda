...
//        val approveOutput_2 = centralBank.services.startFlow(approveRedeem_2).resultFuture.getOrThrow()
        ...
        println("----------------------")
        println("Approve Redeem 3")
        println("----------------------")
//duhd        val approveRedeem_3 = ApproveRedeem.Initiator(issueOutput_3.tx.id.toString(),true)
//duhd        val approveOutput_3 = centralBank.services.startFlow(approveRedeem_3).resultFuture.getOrThrow()
        net.waitQuiescent()
        printCashBalances()
        println()
    }
